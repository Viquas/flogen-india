...
## IMAGES
- Every <img> MUST include src, alt, loading="lazy", and onError fallback to placehold.co.
- Use ONLY verified Unsplash photo IDs or placehold.co URLs. Never invent photo IDs.
...
- Section rhythm: alternate bg-white / bg-zinc-50 / bg-[#FAFAFA].
