                            ...
                            <div className="max-h-40 overflow-y-auto">
                                {filteredIndustries.map((ind) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 text-sm transition-colors flex items-center gap-2 ${ind === industry
                        ...
                        <div className="absolute bottom-full mb-1 left-0 bg-white border border-zinc-200 rounded-lg shadow-lg z-50 py-1 min-w-[100px]">
                            {PRESET_ENTRIES.map((n) => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 text-sm transition-colors ${n === entries ? "bg-purple-50 text-purple-700 font-medium" : "hover:bg-zinc-50 text-zinc-700"
                                        }`}
                                >
                                    {n} {n === 100 ? "(max)" : ""}
                                </button>
